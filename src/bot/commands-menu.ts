export const BOT_COMMANDS = [
  { command: 'start', description: '打开欢迎菜单' },
  { command: 'chat', description: '进入聊天模式' },
  { command: 'settings', description: '切换回复风格' },
  { command: 'setprompt', description: '设置自定义系统提示词' },
  { command: 'usage', description: '查看今日使用次数' },
  { command: 'clear', description: '清空当前会话上下文' },
  { command: 'export', description: '导出当前对话记录' },
  { command: 'favorites', description: '查看收藏的回答' },
